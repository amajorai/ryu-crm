<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Harbor" width="144" />
  </picture>
</p>
...
**App:** [Install](ryu://apps/@ryu/crm) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/crm
```

**Crate:**

```bash
cargo install ryu-crm
```
